...
#define CRY_MODE_ENCOUNTER     2 // Used when starting a static encounter, or when a Pokemon is "aggressive"
...
#define CRY_MODE_FAINT         5 // Used when a Pokemon faints
...
#define CRY_MODE_WEAK         11 // Used when a Pokemon is unhealthy
