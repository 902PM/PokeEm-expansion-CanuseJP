...
#define ITEM_FRIENDSHIP_MAPSEC_BONUS  1   // The amount of bonus friendship gained when an item is used on a Pokemon whose met location matches the current map section.
#define ITEM_FRIENDSHIP_LUXURY_BONUS  1   // The amount of bonus friendship gained when a Pokemon is in the Luxury Ball.
...
#define X_ITEM_MAX_FRIENDSHIP         200 // Friendship threshold at which Pokemon stop receiving a friendship increase from using X items on them in battle.
