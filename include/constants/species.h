...
// NOTE: The defines here are named in order to match Pokemon Showdown's naming conventions. This is done to avoid issues with trainerproc parsing species names. If a Pokemon does not have an entry on Showdown, use your best judgement.
