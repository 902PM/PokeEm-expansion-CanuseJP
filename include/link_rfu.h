...
#define RFU_SERIAL_GAME                0x0002 // Serial number for Pokemon game (FRLG or Emerald)
...
// wireless play (the kind the Pokemon games use) the gname data can be used for
