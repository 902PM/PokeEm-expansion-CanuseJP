...
#define EXP_CAP_HARD                    1 // Pokemon with a level >= the level cap cannot gain any experience
#define EXP_CAP_SOFT                    2 // Pokemon with a level >= the level cap will gain reduced experience
