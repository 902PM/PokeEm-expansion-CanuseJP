...
// Follower Pokemon
#define OW_FOLLOWERS_ENABLED           FALSE      // Enables follower Pokemon, HGSS style. Requires OW_POKEMON_OBJECT_EVENTS. Note that additional scripting may be required for them to be fully supported!
