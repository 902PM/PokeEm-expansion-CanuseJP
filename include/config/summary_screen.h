...
// Level up Relearner
#define P_PRE_EVO_MOVES                  FALSE   // If TRUE, it enables the Pokemon to learn moves from it's pre evolution.
#define P_ENABLE_ALL_LEVEL_UP_MOVES      FALSE   // If TRUE, it enables the Pokemon to learn all level up moves, regardless of its level.

// TM Relearner
#define P_TM_MOVES_RELEARNER             FALSE   // If TRUE, enables machine move relearner.
#define P_ENABLE_ALL_TM_MOVES            FALSE   // If TRUE, it enables the Pokemon to learn all TMs its compatible with, regardless of it being in the bag.
