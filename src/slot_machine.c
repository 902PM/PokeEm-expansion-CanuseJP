...
static const u8 sText_YouveGot9999Coins[] = _("コインが　９９９９まい\nたまって　います");
static const u8 sText_YouveRunOutOfCoins[] = _("コインが　ありません\nゲームを　しゅうりょうします");
static const u8 sText_YouDontHaveThreeCoins[] = _("コインが　３まい　ありません！");
static const u8 sText_ReelTimeHelp[] = _("ＢＤタイム\nじっくり　ねらえば　どんな　マークも\nとめられる　チャンスゲームだ！\nちゅうせん　された　かいすうだけ\nＢＤタイムが　つづくぞ！\nビッグボーナスがでると　しゅうりょう");
