...
{
    {
        .name = {_("サダヒロ"), _("[NULL]"), _("[NULL]"), _("[NULL]"), _("[NULL]"), _("[NULL]")},
        .otId = 48585,
    ...
    {
        .name = {_("ヒロオ"), _("LIONEL"), _("[NULL]"), _("[NULL]"), _("[NULL]"), _("[NULL]")},
        .otId = 53001,
    ...
    {
        .name = {_("ケイジ"), _("[NULL]"), _("[NULL]"), _("[NULL]"), _("[NULL]"), _("[NULL]")},
        .otId = 11828,
    ...
    {
        .name = {_("ユラ"), _("LAYLA"), _("[NULL]"), _("[NULL]"), _("[NULL]"), _("[NULL]")},
        .otId = 34031,
    ...
    {
        .name = {_("ヨウカ"), _("[NULL]"), _("[NULL]"), _("[NULL]"), _("[NULL]"), _("[NULL]")},
        .otId = 7747,
    ...
    {
        .name = {_("ヤスシ"), _("[NULL]"), _("[NULL]"), _("[NULL]"), _("[NULL]"), _("[NULL]")},
        .otId = 14239,
    ...
    {
        .name = {_("ミサオ"), _("[NULL]"), _("[NULL]"), _("[NULL]"), _("[NULL]"), _("[NULL]")},
        .otId = 62805,
    ...
    {
        .name = {_("カズサ"), _("[NULL]"), _("[NULL]"), _("[NULL]"), _("[NULL]"), _("[NULL]")},
        .otId = 36134,
    ...
    {
        .name = {_("スミレ"), _("ANNIE"), _("[NULL]"), _("[NULL]"), _("[NULL]"), _("[NULL]")},
        .otId = 32780,
    ...
    {
        .name = {_("アキノリ"), _("[NULL]"), _("[NULL]"), _("[NULL]"), _("[NULL]"), _("[NULL]")},
        .otId = 18079,
    ...
    {
        .name = {_("トウゾウ"), _("[NULL]"), _("[NULL]"), _("[NULL]"), _("[NULL]"), _("[NULL]")},
        .otId = 29180,
    ...
    {
        .name = {_("セイヤ"), _("FRANK"), _("FRANK"), _("[NULL]"), _("[NULL]"), _("[NULL]")},
        .otId = 41886,
    ...
    {
        .name = {_("リュウジ"), _("[NULL]"), _("[NULL]"), _("[NULL]"), _("JURGEN"), _("[NULL]")},
        .otId = 58768,
    ...
    {
        .name = {_("カツアキ"), _("[NULL]"), _("[NULL]"), _("[NULL]"), _("[NULL]"), _("[NULL]")},
        .otId = 53272,
    ...
    {
        .name = {_("トシミツ"), _("DANTE"), _("[NULL]"), _("[NULL]"), _("[NULL]"), _("[NULL]")},
        .otId = 48245,
    ...
    {
        .name = {_("ローウェン"), _("ARTURO"), _("ARTURO"), _("[NULL]"), _("[NULL]"), _("[NULL]")},
        .otId = 64002,
