...
static const u8 sCreditsText_PackageAndManual[]               = _("[NULL]");
static const u8 sCreditsText_EnglishVersion[]                 = _("[NULL]");
static const u8 sCreditsText_Translator[]                     = _("[NULL]");
static const u8 sCreditsText_TextEditor[]                     = _("[NULL]");
static const u8 sCreditsText_NCLCoordinator[]                 = _("[NULL]");
static const u8 sCreditsText_GraphicDesigner[]                = _("[NULL]");
static const u8 sCreditsText_NOAProductTesting[]              = _("[NULL]");
static const u8 sCreditsText_HideyukiNakajima[]               = _("[NULL]");
static const u8 sCreditsText_HidenoriSaeki[]                  = _("[NULL]");
static const u8 sCreditsText_YokoWatanabe[]                   = _("[NULL]");
static const u8 sCreditsText_SakaeKimura[]                    = _("[NULL]");
static const u8 sCreditsText_ChiakiShinkai[]                  = _("[NULL]");
static const u8 sCreditsText_SethMcMahill[]                   = _("[NULL]");
static const u8 sCreditsText_NobOgasawara[]                   = _("[NULL]");
static const u8 sCreditsText_TeresaLillygren[]                = _("[NULL]");
static const u8 sCreditsText_KimikoNakamichi[]                = _("[NULL]");
static const u8 sCreditsText_SouichiYamamoto[]                = _("[NULL]");
static const u8 sCreditsText_YuichiroIto[]                    = _("[NULL]");
static const u8 sCreditsText_ThomasHertzog[]                  = _("[NULL]");
static const u8 sCreditsText_MikaKurosawa[]                   = _("[NULL]");
static const u8 sCreditsText_NationalFederationBlind[]        = _("[NULL]");
static const u8 sCreditsText_PatriciaAMaurer[]                = _("[NULL]");
static const u8 sCreditsText_EuropeanBlindUnion[]             = _("[NULL]");
static const u8 sCreditsText_AustralianBrailleAuthority[]     = _("[NULL]");
static const u8 sCreditsText_RoyalNewZealandFederationBlind[] = _("[NULL]");
static const u8 sCreditsText_MotoyasuTojima[]                 = _("[NULL]");
static const u8 sCreditsText_NicolaPrattBarlow[]              = _("[NULL]");
static const u8 sCreditsText_ShellieDow[]                     = _("[NULL]");
static const u8 sCreditsText_ErikJohnson[]                    = _("[NULL]");
