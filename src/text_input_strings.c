...
const u8 gText_UnionRoomChatKeyboard_ABCDE[] = _("あいうえお");
const u8 gText_UnionRoomChatKeyboard_FGHIJ[] = _("かきくけこ");
const u8 gText_UnionRoomChatKeyboard_KLMNO[] = _("さしすせそ");
const u8 gText_UnionRoomChatKeyboard_PQRST[] = _("たちつてと");
const u8 gText_UnionRoomChatKeyboard_UVWXY[] = _("なにぬねの");
const u8 gText_UnionRoomChatKeyboard_Z[] = _("はひふへほ");
const u8 gText_UnionRoomChatKeyboard_01234Upper[] = _("マミムメモ");
const u8 gText_UnionRoomChatKeyboard_56789Upper[] = _("ヤユヨ！？");
const u8 gText_UnionRoomChatKeyboard_PunctuationUpper[] = _("ラリルレロ");
const u8 gText_UnionRoomChatKeyboard_SymbolsUpper[] = _("-/&... ");
const u8 gText_UnionRoomChatKeyboard_abcde[] = _("アイウエオ");
const u8 gText_UnionRoomChatKeyboard_fghij[] = _("カキクケコ");
const u8 gText_UnionRoomChatKeyboard_klmno[] = _("サシスセソ");
const u8 gText_UnionRoomChatKeyboard_pqrst[] = _("タチツテト");
const u8 gText_UnionRoomChatKeyboard_uvwxy[] = _("ナニヌネノ");
const u8 gText_UnionRoomChatKeyboard_z[] = _("ハヒフヘホ");
const u8 gText_UnionRoomChatKeyboard_01234Lower[] = _("マミムメモ");
const u8 gText_UnionRoomChatKeyboard_56789Lower[] = _("ヤユヨ！？");
const u8 gText_UnionRoomChatKeyboard_PunctuationLower[] = _("ラリルレロ");
