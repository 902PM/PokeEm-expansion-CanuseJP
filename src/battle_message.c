...
const u8 gText_BattleSwitchWhich5[] = _("ー");
const u8 gText_SafariBalls[] = _("サファリボール");
const u8 gText_SafariBallLeft[] = _("のこり: $");
const u8 gText_Sleep[] = _("[NULL]");
const u8 gText_Poison[] = _("[NULL]");
const u8 gText_Burn[] = _("[NULL]");
const u8 gText_Paralysis[] = _("[NULL]");
const u8 gText_Ice[] = _("[NULL]");
const u8 gText_Confusion[] = _("[NULL]");
const u8 gText_Love[] = _("[NULL]");
const u8 gText_SpaceAndSpace[] = _(" と ");
const u8 gText_CommaSpace[] = _("[NULL]");
const u8 gText_Space2[] = _("　");
const u8 gText_LineBreak[] = _("\l");
const u8 gText_NewLine[] = _("\n");
const u8 gText_Are[] = _("は\r");
const u8 gText_Are2[] = _("は\r");
...
{
    [DOME_ROUND1]    = COMPOUND_STRING("１かい"),
    [DOME_ROUND2]    = COMPOUND_STRING("２かい"),
