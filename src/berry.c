...
const struct Berry gBerries[NUM_BERRIES + 1] =
{
    ...
    [BERRY_ID_IAPAPA] =
    {
        .info = {
            ...
            .description2 = COMPOUND_STRING("そだてるには　みじかくても　１にち　かかる。"),
            .growthDuration = GROWTH_DURATION(24, 20, 30, 24, 16, 24),
            .spicy = 0,
            .dry = 0,
            .sweet = 0,
    ...
    [BERRY_ID_RAZZ] =
    {
        .info = {
            ...
            .description2 = COMPOUND_STRING("そだつのが　はやく　４じかんで　みを　つける"),
    ...
    [BERRY_ID_NOMEL] =
    {
        .info = {
            ...
            .maxYield = YIELD_RATE(4, 10, 15, 15),
            .minYield = YIELD_RATE(2, 2, 3, 3),
            .description1 = COMPOUND_STRING("かなり　すっぱい。　１くち　たべると"),
            .description2 = COMPOUND_STRING("３にちかん　ほかの　あじが　しなくなる。"),
            .growthDuration = GROWTH_DURATION(24, 24, 36, 24, 16, 24),
            .spicy = 10,
            .dry = 0,
            .sweet = 0,
