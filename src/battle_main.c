...
static const u8 sText_ShedinjaJpnName[] = _("[NULL]"); // Nukenin
...
const struct TrainerClass gTrainerClasses[TRAINER_CLASS_COUNT] =
{
    ...
    [TRAINER_CLASS_COOLTRAINER] = { _("エリートレーナー"), 12, BALL_ULTRA },
    ...
    [TRAINER_CLASS_BLACK_BELT] = { _("くろおび"), 8, BALL_ULTRA },
    ...
    [TRAINER_CLASS_TUBER_F] = { _("うきわボーイ"), 1 },
    [TRAINER_CLASS_TUBER_M] = { _("うきわボーイ"), 1 },
    [TRAINER_CLASS_LADY] = { _("ちゃん"), 50 },
    [TRAINER_CLASS_BEAUTY] = { _("うつくしい"), 20, B_TRAINER_CLASS_POKE_BALLS >= GEN_8 ? BALL_GREAT : BALL_POKE },
    ...
    [TRAINER_CLASS_PSYCHIC] = { _("エスパー"), 6 },
    [TRAINER_CLASS_GENTLEMAN] = { _("ジェントルマン"), 20, BALL_LUXURY },
    [TRAINER_CLASS_ELITE_FOUR] = { _("してんのう"), 25, BALL_ULTRA },
    [TRAINER_CLASS_LEADER] = { _("リーダー"), 25, B_TRAINER_CLASS_POKE_BALLS >= GEN_8 ? BALL_ULTRA : BALL_POKE },
    ...
    [TRAINER_CLASS_BEAUTY_FRLG] =          { _("うつくしい"), 18 },
    [TRAINER_CLASS_SWIMMER_F_FRLG] =       { _("ビキニのおねえさん"), 1, BALL_DIVE },
    [TRAINER_CLASS_PSYCHIC_FRLG] =         { _("エスパー"), 5 },
    ...
    [TRAINER_CLASS_TUBER_FRLG] =           { _("うきわボーイ"), 1 },
    ...
    [TRAINER_CLASS_LADY_FRLG] =            { _("ちゃん"), 50 },
